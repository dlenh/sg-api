        ...
        const minutes = {
            item1: () => {
                ...
                if (!item1.style.border) {
                    item1.style.border = "2px red solid";
                } else {
                    item1.style.border = "";
                }
            ...
            item2: () => {
                ...
                if (!item2.style.border) {
                    item2.style.border = "2px red solid";
                } else {
                    item2.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item3: () => {
                ...
                if (!item3.style.border) {
                    item3.style.border = "2px red solid";
                } else {
                    item3.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item4: () => {
                ...
                if (!item4.style.border) {
                    item4.style.border = "2px red solid";
                } else {
                    item4.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item5: () => {
                ...
                if (!item5.style.border) {
                    item5.style.border = "2px red solid";
                } else {
                    item5.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item6: () => {
                ...
                if (!item6.style.border) {
                    item6.style.border = "2px red solid";
                } else {
                    item6.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item7: () => {
                ...
                if (!item7.style.border) {
                    item7.style.border = "2px red solid";
                } else {
                    item7.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item8: () => {
                ...
                if (!item8.style.border) {
                    item8.style.border = "2px red solid";
                } else {
                    item8.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item9: () => {
                ...
                if (!item9.style.border) {
                    item9.style.border = "2px red solid";
                } else {
                    item9.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item10: () => {
                ...
                if (!item10.style.border) {
                    item10.style.border = "2px red solid";
                } else {
                    item10.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item11: () => {
                ...
                if (!item11.style.border) {
                    item11.style.border = "2px red solid";
                } else {
                    item11.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item12: () => {
                ...
                if (!item12.style.border) {
                    item12.style.border = "2px red solid";
                } else {
                    item12.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item13: () => {
                ...
                if (!item13.style.border) {
                    item13.style.border = "2px red solid";
                } else {
                    item13.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item14: () => {
                ...
                if (!item14.style.border) {
                    item14.style.border = "2px red solid";
                } else {
                    item14.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item15: () => {
                ...
                if (!item15.style.border) {
                    item15.style.border = "2px red solid";
                } else {
                    item15.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item16: () => {
                ...
                if (!item16.style.border) {
                    item16.style.border = "2px red solid";
                } else {
                    item16.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item17: () => {
                ...
                if (!item17.style.border) {
                    item17.style.border = "2px red solid";
                } else {
                    item17.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item18: () => {
                ...
                if (!item18.style.border) {
                    item18.style.border = "2px red solid";
                } else {
                    item18.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item19: () => {
                ...
                if (!item19.style.border) {
                    item19.style.border = "2px red solid";
                } else {
                    item19.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item20: () => {
                ...
                if (!item20.style.border) {
                    item20.style.border = "2px red solid";
                } else {
                    item20.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item21: () => {
                ...
                if (!item21.style.border) {
                    item21.style.border = "2px red solid";
                } else {
                    item21.style.border = "";
                }
                total.innerText = totalMin;
            ...
            item22: () => {
                ...
                if (!item22.style.border) {
                    item22.style.border = "2px red solid";
                } else {
                    item22.style.border = "";
                }
                total.innerText = totalMin;
